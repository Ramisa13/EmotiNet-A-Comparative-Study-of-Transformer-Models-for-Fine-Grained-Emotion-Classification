#!/bin/bash
#SBATCH --job-name=distil_bert-emotion
#SBATCH --output=bert_output_%j.txt
#SBATCH --error=bert_error_%j.txt
...
yes | python3 /scratch/project_2011211/Fahim/affective_computing/distil_bert.py
