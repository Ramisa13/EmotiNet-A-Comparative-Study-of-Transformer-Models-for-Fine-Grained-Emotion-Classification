#!/bin/bash
#SBATCH --job-name=mobert-emotion
#SBATCH --output=mobert_output_%j.txt
#SBATCH --error=mobert_error_%j.txt
...
yes | python3 /scratch/project_2011211/Fahim/affective_computing/modern_bert.py
